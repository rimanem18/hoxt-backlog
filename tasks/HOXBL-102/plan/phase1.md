...
- [ ] **TASK-1-01: `project_viewers`への`notificationEnabled`列追加とスキーマ再生成**
  - **タイプ**: DIRECT
  - **依存タスク**: なし
...
- [ ] **TASK-1-02: ProjectViewerEntityへの通知ON/OFF状態追加**
  - **タイプ**: TDD
  - **依存タスク**: TASK-1-01
...
- [ ] **TASK-1-03: IProjectViewerRepositoryへの通知設定永続化・取得メソッド追加**
  - **タイプ**: TDD
  - **依存タスク**: TASK-1-02
...
- [ ] **TASK-1-04: UpdateNotificationSettingUseCase新規実装**
  - **タイプ**: TDD
  - **依存タスク**: TASK-1-03
...
- [ ] **TASK-1-06: GET /api/viewer/tasksレスポンスへのnotificationEnabled追加**
  - **タイプ**: TDD
  - **依存タスク**: TASK-1-03
  - **関連要件**: REQ-002, AC-06
