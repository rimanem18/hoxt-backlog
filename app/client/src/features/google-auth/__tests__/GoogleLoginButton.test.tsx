...
// 【モック実装】: Supabase Auth SDKのモック設定
// 【テスト方針】: 実際のSupabaseサービスを呼び出さず、関数呼び出しのみを検証
const mockSignInWithOAuth = mock(() => Promise.resolve({ data: null, error: null }));

// 【Supabaseクライアントモック】: createClient関数全体をモック化
...
// 【テストファイル名】: GoogleLoginButton.test.tsx
