...
### 5. 検証結果のメモファイル記録とdocs/todo.md更新
...
#### docs/todo.md完了マーク自動更新

検証が完了した場合、以下の手順でdocs/todo.mdを自動更新：
...
**docs/todo.md更新**: 完了したタスクに✅完了マークを自動追加する。
...
**docs/todo.md更新**: 実装不足の場合でも、部分完了したタスクがあれば適切にマークする。

## 検証対象ファイル

### 確認すべきドキュメント
- `docs/todo.md` - プロジェクト全体のタスク完了状況（完了マーク更新対象）
- `docs/implements/{{task_id}}/{feature_name}-requirements.md`
- `docs/implements/{{task_id}}/{feature_name}-testcases.md`
